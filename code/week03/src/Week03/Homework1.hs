...
mkValidator dat () ctx = case deadlineReached of
    True  -> traceIfFalse "missing sinature of beneficiary 2" signedByBeneficiary2
    False -> traceIfFalse "missing sinature of beneficiary 1" signedByBeneficiary1
  where
    info :: TxInfo
