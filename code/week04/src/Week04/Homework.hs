...
payContract = do
    ...
    Contract.handleError (\err ->
      Contract.logError @String $ "Opa greshka: " ++ unpack err)
      $ void $ submitTx tx
    payContract
...
payTrace a1 a2 = do
  ...
  callEndpoint @"pay" h PayParams { ppRecipient = mockWalletPaymentPubKeyHash $ knownWallet 2 
                                  , ppLovelace = a1
                                  }
